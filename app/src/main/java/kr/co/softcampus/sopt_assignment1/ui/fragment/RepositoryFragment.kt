...
import kr.co.softcampus.sopt_assignment1.ui.adapter.RepositoryAdapter
import kr.co.softcampus.sopt_assignment1.data.local.RepositoryData
    ...
    private fun initAdapter() {
        ...
        repositoryAdapter.RepositoryList.addAll(
            listOf(
                ...
                RepositoryData(
                    "SOPT 과제 레포지토리",
                    "안드로이드 파트 과제, ios 파트 과제, 서버 파트 과제, 기획 파트 과제, 웹 파트 과제, 디자인 파트 과제"
                )
            )
        )
